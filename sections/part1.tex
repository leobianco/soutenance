...
\begin{frame}{Results}
    ...
    \begin{tcolorbox}[colback=yellow!45!white,
        ...
        \textbf{Theorem~\citep{bianco2025subsearchrobustestimationoutlier}.} Let \(S\) be a subgraph clustered into \(S_1, \dotsc, S_K\), \(\Omega_k\) the nodes in community \(k\), \(\mathcal{I}\) the inliers.
        Let
