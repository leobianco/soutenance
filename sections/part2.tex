...
\begin{frame}{Research questions}
    \textbf{Problem}: \(\mathcal{D}_{\textup{RM}}\) is costly, time-consuming, and error-prone to get\pause
    \\[1em]
    \(\hookrightarrow\) Synthetic hallucinations are cheap, fast, error-free
    \\[1em]
